...
let InstitutionUsersController = class InstitutionUsersController {
    ...
    async create(createInstitutionUserDto, authUser) {
        ...
        let { role_id, permission_id, first_name, last_name, username, email, phone_number, home_address, state_of_residence, lga, geo_political_zone, institution_id } = createInstitutionUserDto;
        ...
        }, 'Institution User Registration', 'Institution User successfully registered');
    }
    async search(query, perPage = 12) {
        ...
        }), 'Institution User', 'Institution User List', {
            current_page: 1,
            next_page: null,
            prev_page: null,
            per_page: total,
    ...
    async findAll(page = 1, perPage = 12, query, from, to) {
        ...
        return utils_1.success(users, 'Institution User', 'Institution User List', {
            current_page: _page,
    ...
    async findOne(id) {
        ...
        return utils_1.success(user ? Object.assign({}, user) : null, 'Institution User', 'Institution User Details');
    }
    async update(id, user) {
        ...
        }, 'Institution User', 'Institution User Details Updated');
    }
...
__decorate([
    common_1.Get('institution-users-managment-analysis'),
    common_1.UseGuards(jwt_guard_1.JwtGuard),
    swagger_1.ApiBearerAuth(),
    __metadata("design:type", Function),
...
InstitutionUsersController = __decorate([
    common_1.Controller('institution-users'),
