...
InstitutionUsersModule = __decorate([
    common_1.Module({
        imports: [typeorm_1.TypeOrmModule.forFeature([institution_user_entity_1.InstitutionUser, estate_entity_1.Institution, user_1.User]), services_1.ServicesModule],
