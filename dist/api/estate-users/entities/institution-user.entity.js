...
__decorate([
    typeorm_1.Column('varchar', { name: 'estate_id', nullable: true, length: 36 }),
    __metadata("design:type", String)
], InstitutionUser.prototype, "estate_id", void 0);
__decorate([
...
__decorate([
    typeorm_1.ManyToOne(() => estate_entity_1.Institution, (institution) => institution.institutionUser, { eager: true }),
    typeorm_1.JoinColumn({ name: "estate_id" }),
