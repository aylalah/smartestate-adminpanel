...
exports.endpointsRequiringAdmin = exports.endpointsRequiringPin = exports.openEndpoints = exports.openServices = exports.services = void 0;
const services = () => ({
    eligibility: {
        name: 'eligibility',
        alias: 'cancanta',
...
exports.openServices = openServices;
const openEndpoints = () => ([
    {
        method: 'get',
        pattern: 'cards/isw/*',
...
exports.openEndpoints = openEndpoints;
const endpointsRequiringPin = () => ([
    {
        method: 'post',
...
exports.endpointsRequiringPin = endpointsRequiringPin;
const endpointsRequiringAdmin = () => ([
    {
        method: 'post',
        pattern: 'wallet/*',
    },
]);
exports.endpointsRequiringAdmin = endpointsRequiringAdmin;
